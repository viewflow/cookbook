...
class Forms(Application):
    ...
    bank_form_path = path(
        ...
        generic.FormView.as_view(
            form_class=BankForm, success_url='/forms/bank/', template_name='forms/form.html',
            extra_context={'title': 'Personal Bank Account Initial Application', 'button': 'Save application'}
        ),
        name='bank_form',
    )
    ...
    checkout_form_path = path(
        'checkout/',
        generic.FormView.as_view(
            form_class=CheckoutForm, success_url='/forms/checkout/', template_name='forms/form.html',
    ...
    comment_form_path = path(
        'comment/',
        generic.FormView.as_view(
            form_class=CommentForm, success_url='/forms/comment/', template_name='forms/form.html',
    ...
    contact_form_path = path(
        'contact/',
        generic.FormView.as_view(
            form_class=ContactForm, success_url='/forms/contact/', template_name='forms/form.html',
    ...
    hospital_form_path = path(
        'hospital/',
        generic.FormView.as_view(
            form_class=HospitalRegistrationForm, success_url='/forms/hospital/', template_name='forms/form.html',
            extra_context={'title': 'Hospital registration form', 'button': 'Registration'}
        ),
        name='hospital_form',
    )
    ...
    login_form_path = path(
        'login/',
        generic.FormView.as_view(
            form_class=LoginForm, success_url='/forms/login/', template_name='forms/form.html',
    ...
    order_form_path = path(
        'order/',
        generic.FormView.as_view(
            form_class=OrderForm, success_url='/forms/order/', template_name='forms/form.html',
    ...
    profile_form_path = path(
        'profile/',
        generic.FormView.as_view(
            form_class=ProfileForm, success_url='/forms/profile/', template_name='forms/form.html',
    ...
    registration_form_path = path(
        'registration/',
        generic.FormView.as_view(
            form_class=RegistrationForm, success_url='/forms/registration/', template_name='forms/form.html',
    ...
    signup_form_path = path(
        'signup/',
        generic.FormView.as_view(
            form_class=SignupForm, success_url='/forms/signup/', template_name='forms/form.html',
